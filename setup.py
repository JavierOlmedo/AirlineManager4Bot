...
setup(
  name='ALMB',         # How you named your folder
  packages=['ALMB'],   # Chose the same as "name"
  ...
  url='https://github.com/JavierOlmedo/ALMB',   # Provide either the link to your github or to your website
  download_url='https://github.com/JavierOlmedo/ALMB/archive/1.1.tar.gz',    # I explain this later on
